...
import integration.phone.pages.variations.planapplicationpage.OHPlanApplicationQuestions;
...
public class OhioIntegrationTest extends CQBaseIntegrationTest {
    ...
    @Page public OHPlanApplicationQuestions planApplicationQuestionsPage;
    ...
    @Test
    public void test_ohio_full_underwriting_with_rn() throws Exception {

        sheet.setRandomNameGenderAndMembershipNumber();
        sheet.setRandomAddress("OH", "44444");
    ...
    @Test
    public void test_ohio_full_underwriting_without_rn() throws Exception {
