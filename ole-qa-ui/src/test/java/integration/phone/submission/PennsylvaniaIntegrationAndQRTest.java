...
import integration.phone.phonePages.oldOlePages.variations.planapplication.VA_NJ_IL_LA_NC_KY_AR_PlanApplicationQuestions;
import integration.phone.phonePages.oldOlePages.variations.replacementnotice.RN078Page;
...
public class PennsylvaniaIntegrationAndQRTest extends CQBaseIntegrationTest {
    ...
    public void test_pennsylvania_health_history_underwriting_with_rn() throws Exception {
        ...
        planApplicationQuestionsPage.clickNextAndWaitForSpinnerToFinish();
        eligibilityHealthQuestionsPage.clickNextAndWaitForSpinnerToFinish();
        healthHistoryQuestionsPage.clickNextAndWaitForSpinnerToFinish();
