...
import pages.phone.*;
import pages.phone.variations.pastandcurrentcoverage.GAandMIPastAndCurrentInsuranceCoveragePage;
...
public class ArizonaIntegrationTest extends CQBaseIntegrationTest {
    ...
    public void setup() {
        ...
        sheet.setRandomAddress("AZ", "85001");
    ...
    @Test
    public void test_arizona_full_underwriting_with_rn() throws Exception {
    ...
    @Test
    public void test_arizona_full_underwriting_without_rn() throws Exception {
