...
public class OR_PastAndCurrentInsuranceCoveragePage extends WizardPage {
    ...
    @FindBy(css = "#ContinuousMedicareCoverageNoGap_1") FluentWebElement ContinuousMedicareCoverageNoGap_Yes;
    @FindBy(css = "#ContinuousMedicareCoverageNoGap_2") FluentWebElement ContinuousMedicareCoverageNoGap_No;
    ...
    public void verifyInitialStateOfElements(Application app) {
        ...
        assertHidden(OtherMedplanstart,
            OtherMedplanend,
            ContinuousMedicareCoverageNoGap_Yes,
            ContinuousMedicareCoverageNoGap_No,
            IntentReplace_Yes,
            IntentReplace_No,
    ...
    public void fillAndSubmit(Application app) {
        ...
        if(app.getExistingMedicare().equals("yes")){
            ...
            fillYesNoQuestion(ContinuousMedicareCoverageNoGap_Yes, ContinuousMedicareCoverageNoGap_No, app.getContinuousMedicareCoverageNoGap());
    ...
    public void verifyStateOfElementAfterAnswers(Application app) {
        ...
        assertYesNoQuestion(ContinuousMedicareCoverageNoGap_Yes, ContinuousMedicareCoverageNoGap_No, app.getFirstTime());
