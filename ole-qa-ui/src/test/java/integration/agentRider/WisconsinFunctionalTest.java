...
public class WisconsinFunctionalTest extends CQBaseIntegrationTest {
    ...
    @Test
    public void test_wisconson_basic_plan_with_rider_1_3() throws Exception {
    ...
    @Ignore
    public void test_wisconsin_eligibility_healthhistory_underwriting_with_rn() throws Exception {
