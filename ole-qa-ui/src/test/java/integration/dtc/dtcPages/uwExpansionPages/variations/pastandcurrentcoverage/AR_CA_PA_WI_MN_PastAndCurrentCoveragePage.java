...
public class AR_CA_PA_WI_MN_PastAndCurrentCoveragePage extends WizardPage{
    ...
    @FindBy(css = "#MSInsCompany") FluentWebElement MSInsCompany;
    @FindBy(css = "#MSPLAN") FluentWebElement MSPLAN;
