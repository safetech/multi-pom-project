...
public class PastAndCurrentCoveragePage extends WizardPage {
    ...
    @FindBy(css = "#UnderstandPandC_1") FluentWebElement UnderstandAndAuthorize_Yes;
    @FindBy(css = "#UnderstandPandC_2") FluentWebElement UnderstandAndAuthorize_No;
    ...
    public void fillAndSubmit(Application app) {
        fillYesNoQuestion(UnderstandAndAuthorize_Yes, UnderstandAndAuthorize_No, app.getUnderstandAndAuthorize());
