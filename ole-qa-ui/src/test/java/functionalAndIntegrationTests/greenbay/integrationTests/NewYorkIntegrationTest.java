package functionalAndIntegrationTests.greenbay.integrationTests;
...
import queries.GreenbaySubmissionQuery;
...
public class NewYorkIntegrationTest extends CQBaseIntegrationTest {
    ...
    public GreenbaySubmissionQuery submissionQuery;
    private Faker faker;
    private SubmissionResult expectedSubmissionResult;
    private CribSheet sheet;
    @Before
    public void setup() {
        submissionQuery = new GreenbaySubmissionQuery();
        faker = new Faker();
