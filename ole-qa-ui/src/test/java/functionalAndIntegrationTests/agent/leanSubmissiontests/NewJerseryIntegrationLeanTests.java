...
public class NewJerseryIntegrationLeanTests extends CQBaseIntegrationTest {
    ...
    public void setup() {
        ...
        app = new Application();
        app.setState("NJ");
        app.setZipCode("08406");
        agentID = "2039962";

        marketabilityCode = "M93343AGMMNJ01_02B";
    ...
    @Test
    public void AGENT_NewJersey_GI() throws Exception {
    ...
    @Test
    public void AGENT_NewJersey_Eligibility_FU_With_RN() throws Exception {
