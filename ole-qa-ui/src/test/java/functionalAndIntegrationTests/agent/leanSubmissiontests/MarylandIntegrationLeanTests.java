...
public class MarylandIntegrationLeanTests extends CQBaseIntegrationTest {
    ...
    public void setup() {
        ...
        app = new Application();
        app.setState("MD");
        app.setZipCode("20601");
        agentID = "2039962";

        marketabilityCode = "M10L43AGMMMD01_01C";
    ...
    @Test
    public void AGENT_Maryland_GI() throws Exception {
    ...
    @Test
    public void AGENT_Maryland_Eligibility_FU_With_RN() throws Exception {
