...
public class NewMexicoIntegrationLeanTests extends CQBaseIntegrationTest {
    ...
    public void setup() {
        ...
        app = new Application();
        app.setState("NM");
        app.setZipCode("87070");
        agentID = "2039962";

        marketabilityCode = "M90043AGMMNM01_02B";
    ...
    @Test
    public void AGENT_NewMexico_GI() throws Exception {
    ...
    @Test
    public void AGENT_NewMexico_Eligibility_FU_With_RN() throws Exception {
