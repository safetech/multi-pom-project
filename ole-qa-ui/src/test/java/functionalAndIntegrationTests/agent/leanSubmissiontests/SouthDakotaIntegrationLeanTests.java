...
public class SouthDakotaIntegrationLeanTests extends CQBaseIntegrationTest {
    ...
    public void setup() {
        ...
        app = new Application();
        app.setState("SD");
        app.setZipCode("57057");
        agentID = "2039962";

        marketabilityCode = "M90643AGMMSD01_02B";
    ...
    @Test
    public void AGENT_SouthDakota_GI() throws Exception {
    ...
    @Test
    public void AGENT_SouthDakota_Eligibility_FU_With_RN() throws Exception {
