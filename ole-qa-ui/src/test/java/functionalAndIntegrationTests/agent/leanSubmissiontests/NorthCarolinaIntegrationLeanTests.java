...
public class NorthCarolinaIntegrationLeanTests extends CQBaseIntegrationTest {
    ...
    public void setup() {
        ...
        app = new Application();
        app.setState("NC");
        app.setZipCode("27006");
        agentID = "2039962";

        marketabilityCode = "S11E43AGMMNC01_01C";
    ...
    @Test
    public void AGENT_NorthCarolina_GI() throws Exception {
    ...
    @Test
    public void AGENT_NorthCarolina_Eligibility_FU_With_RN() throws Exception {
