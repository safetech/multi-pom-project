...
public class SouthCarolinaIntegrationLeanTests extends CQBaseIntegrationTest {
    ...
    public void setup() {
        ...
        app = new Application();
        app.setState("SC");
        app.setZipCode("29001");
        agentID = "2039962";

        marketabilityCode = "M74943AGMMSC01_02B";
    ...
    @Test
    public void AGENT_SouthCarolina_GI() throws Exception {
    ...
    @Test
    public void AGENT_SouthCarolina_Eligibility_FU_With_RN() throws Exception {
